...
if(isset($_REQUEST["ajax"])){
	...
	if($selectedpath = checkpath($selectedpath, $uploadpath)){
		...
		die('0||'.translate_pdw("The folder path was tampered with!"));
	}
} else {
...
print '<table id="details" class="files">
		<thead>
			<tr>
				<th colspan="3" class="filename">'.translate_pdw("Filename").'</th>
				<th>'.translate_pdw("Modified on").'</th>
				<th>'.translate_pdw("Filetype").'</th>
				<th>'.translate_pdw("Size").'</th>
				<th>'.translate_pdw("Dimensions").'</th>
				<th class="end">&nbsp;</th>
			</tr>
		</thead>
		<tbody>';
